Rails.application.routes.draw do
  ...
  post 'professional/professional_services/create' =>  'professionals#create_professional_services', as: 'professionals_create_professional_services', :defaults => { :format => 'js' }
